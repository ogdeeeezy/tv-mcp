/**
 * Core health and discovery logic.
 *
 * The old `launch()` function — which detected and started TradingView
 * Desktop (Electron) via OS-specific binary path probing — was removed in
 * 2026-05 after the Phase 3 audit. The MCP only targets web-Chrome now;
 * see `core/diagnostics.js` chromeLaunch for the current launch path.
 */
